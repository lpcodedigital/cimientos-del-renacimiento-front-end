...
const AllCursos: React.FC = () => {
    ...
    const { curso: detalle, loading: loadingDetalle, error: errorDetalle, getDetalle } = useCursoDetalle();
        ...
        <>
            ...
            <main>
                ...
                <section id="allcursos">
                    ...
                    <TitleSection title="Todas las capacitaciones" />
